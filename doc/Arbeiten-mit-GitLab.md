...
Je nach bestehender Konfiguration müssen Sie dazu noch im Konfigurationsdialog **File->Project Structure->SDKs** ein JDK 25 unter dem Namen "25" anlegen und referenzieren.
Achtung: Bitte immer nur ein JDK 25 (LTS Release) nutzen und keine neuere Version verwenden, da viele Bibliotheken und Werkzeuge evtl. noch nicht darauf angepasst sind.
...
Alternativ können Sie für diese Schritte auch die Kommandozeile nutzen.
...
Diese Kopie kann mit folgendem Beispielkommando auf den eigenen Rechner geholt werden (die URL müssen Sie durch Ihr persönliches Projekt ersetzen):
