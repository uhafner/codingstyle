...
/** Represents the mutators available in PIT. This enum maps each mutator name to its fully qualified class name. */
public enum PitMutator {
    ...
    EXPERIMENTAL_REMOVE_SWITCH_MUTATOR_0(
            "org.pitest.mutationtest.engine.gregor.mutators.experimental.RemoveSwitchMutator_0"), // todo maybe find a
    // better solution for
    // n cases
