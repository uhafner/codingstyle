...
public class StringUtils {
     ...
     * a "left edge" offset.  Note that this left edge is not necessarily going to be the leftmost character in the
     * result, or the first character following the replacement marker, but it will appear somewhere in the result.
     *
     ...
     * String)}. This method uses {@link String#endsWith(String)}.</p>
     *
     * <pre>
     * StringUtils.chomp(null, *)         = null
     * StringUtils.chomp("", *)           = ""
     ...
     *
     * <p>A {@code null} CharSequence will return {@code false}.
     * A {@code null} valid character array will return {@code false}. An empty CharSequence (length()=0) always returns
     * {@code true}.</p>
     *
     * <pre>
     ...
     * points. A higher score indicates a higher similarity.</p>
     *
     * <pre>
     ...
     * @param locale
     *         This string matching logic is case insensitive. A locale is necessary to normalize both Strings to lower
     *         case.
     *
     * @return result score
     * @throws IllegalArgumentException
     ...
     *         the supplier of default CharSequence to return if the input is whitespace, empty ("") or {@code null},
     *         may be null
     *
     * @return the passed in CharSequence, or the default
     * @see StringUtils#defaultString(String, String)
     ...
     *         the CharSequence to check, may be null
     * @param defaultSupplier
     *         the supplier of default CharSequence to return if the input is empty ("") or {@code null}, may be null
     *
     * @return the passed in CharSequence, or the default
     * @see StringUtils#defaultString(String, String)
     * @since 3.10
     ...
     * A negative start position is treated as zero. An empty ("") search CharSequence always matches. A start position
     * greater than the string length only matches an empty search CharSequence.</p>
     *
     * <pre>
     * StringUtils.indexOf(null, *, *)          = -1
     * StringUtils.indexOf(*, null, *)          = -1
    ...
    /**
     * Returns the index within {@code seq} of the first occurrence of the specified character. If a character with
     * value {@code searchChar} occurs in the character sequence represented by {@code seq} {@code CharSequence} object,
     * then the index (in Unicode code units) of the first such occurrence is returned. For values of {@code searchChar}
     * in the range from 0 to 0xFFFF (inclusive), this is the smallest value <i>k</i> such that:
     * <blockquote><pre>
     ...
     * </pre></blockquote>
     * is true. In either case, if no such character occurs in {@code seq}, then {@code INDEX_NOT_FOUND (-1)} is
     * returned.
     *
    ...
    /**
     * Returns the index within {@code seq} of the first occurrence of the specified character, starting the search at
     * the specified index.
     * <p>
     * If a character with value {@code searchChar} occurs in the character sequence represented by the {@code seq}
     * {@code CharSequence} object at an index no smaller than {@code startPos}, then the index of the first such
     * occurrence is returned. For values of {@code searchChar} in the range from 0 to 0xFFFF (inclusive), this is the
     ...
     * </pre></blockquote>
     * is true. In either case, if no such character occurs in {@code seq} at or after position {@code startPos}, then
     * {@code -1} is returned.
     *
     * <p>
     * There is no restriction on the value of {@code startPos}. If it is negative, it has the same effect as if it were
     * zero: this entire string may be searched. If it is greater than the length of this string, it has the same effect
     * as if it were equal to the length of this string: {@code (INDEX_NOT_FOUND) -1} is returned. Furthermore, a {@code
     * null} or empty ("") CharSequence will return {@code (INDEX_NOT_FOUND) -1}.
     *
     ...
     * ignored, but a search array containing "" will return {@code 0} if {@code str} is not null. This method uses
     * {@link String#indexOf(String)} if possible.</p>
     *
     * <pre>
     * StringUtils.indexOfAny(null, *)                      = -1
     * StringUtils.indexOfAny(*, null)                      = -1
     ...
     *         the separator character to use
     * @param startIndex
     *         the first index to start joining from. It is an error to pass in a start index past the end of the array
     * @param endIndex
     ...
     *         the separator character to use
     * @param startIndex
     *         the first index to start joining from.  It is an error to pass in a start index past the end of the list
     * @param endIndex
     *         the index to stop joining from (exclusive). It is an error to pass in an end index past the end of the
     *         list
     *
     ...
     *
     * <p>No delimiter is added before or after the list.
     * A {@code null} separator is the same as an empty String (""). Null objects or empty strings within the array are
     * represented by empty strings.</p>
     *
     * <pre>
     * StringUtils.join(null, *)                = null
     * StringUtils.join([], *)                  = ""
     ...
     *
     * @return the joined String, {@code null} if null array input; or the empty string if {@code endIndex - startIndex
     *         <= 0}. The number of joined entries is given by {@code endIndex - startIndex}
     * @throws ArrayIndexOutOfBoundsException
     *         ife<br> {@code startIndex < 0} or <br> {@code startIndex >= array.length()} or <br> {@code endIndex < 0}
     *         or <br> {@code endIndex > array.length()}
     */
     ...
     *
     * <p>A {@code null} CharSequence will return {@code -1}.
     * A negative start position returns {@code -1}. An empty ("") search CharSequence always matches unless the start
     * position is negative. A start position greater than the string length searches the whole string. The search
     * starts at the startPos and works backwards; matches starting after the start position are ignored.
     * </p>
     *
     * <pre>
     * StringUtils.lastIndexOf(null, *, *)          = -1
    ...
    /**
     * Returns the index within {@code seq} of the last occurrence of the specified character. For values of {@code
     * searchChar} in the range from 0 to 0xFFFF (inclusive), the index (in Unicode code units) returned is the largest
     ...
     * this.codePointAt(<i>k</i>) == searchChar
     * </pre></blockquote>
     * is true.  In either case, if no such character occurs in this string, then {@code -1} is returned. Furthermore, a
     * {@code null} or empty ("") {@code CharSequence} will return {@code -1}. The {@code seq} {@code CharSequence}
     ...
     *
     * @param seq
     *         the {@code CharSequence} to check, may be null
     * @param searchChar
     *         the character to find
     *
    ...
    /**
     * Returns the index within {@code seq} of the last occurrence of the specified character, searching backward
     * starting at the specified index. For values of {@code searchChar} in the range from 0 to 0xFFFF (inclusive), the
     * index returned is the largest value <i>k</i> such that:
     * <blockquote><pre>
     * (this.charAt(<i>k</i>) == searchChar) &amp;&amp; (<i>k</i> &lt;= startPos)
     * </pre></blockquote>
     * is true. For other values of {@code searchChar}, it is the largest value <i>k</i> such that:
     ...
     * (this.codePointAt(<i>k</i>) == searchChar) &amp;&amp; (<i>k</i> &lt;= startPos)
     * </pre></blockquote>
     * is true. In either case, if no such character occurs in {@code seq} at or before position {@code startPos}, then
     * {@code -1} is returned. Furthermore, a {@code null} or empty ("") {@code CharSequence} will return {@code -1}. A
     * start position greater than the string length searches the whole string. The search starts at the {@code
     ...
     * ignored, but a search array containing "" will return the length of {@code str} if {@code str} is not null. This
     * method uses {@link String#indexOf(String)} if possible</p>
     *
     * <pre>
     ...
     * <p>A {@code null} CharSequence will return {@code -1}.
     * A negative start position returns {@code -1}. An empty ("") search CharSequence always matches unless the start
     * position is negative. A start position greater than the string length searches the whole string.</p>
     *
     * <pre>
     ...
     * String is {@code null}, the String will be returned without an exception. An empty String is returned if len is
     * negative.</p>
     *
     * <pre>
     ...
     * the result of this method is affected by the current locale. For platform-independent case transformations, the
     * method {@link #lowerCase(String, Locale)} should be used with a specific locale (e.g. {@link
     * Locale#ENGLISH}).</p>
     *
     * @param str
     ...
     * returned. An empty String is returned if len is negative or exceeds the length of {@code str}.</p>
     *
     * <pre>
    ...
    /**
     * <p>
     * Similar to <a href="http://www.w3.org/TR/xpath/#function-normalize-space">http://www.w3.org/TR/xpath/#function-normalize
     * -space</a>
     * </p>
     * <p>
     * The function returns the argument string with whitespace normalized by using {@code {@link #trim(String)}} to
     * remove leading and trailing whitespace and then replacing sequences of whitespace characters by a single space.
     * </p>
     * In XML Whitespace characters are the same as those allowed by the <a href="http://www.w3.org/TR/REC-xml/#NT-S">S</a>
     * production, which is S ::= (#x20 | #x9 | #xD | #xA)+
     * <p>
     ...
     * incrementing the starting index by one after each successful match (unless {@code searchStr} is an empty string
     * in which case the position is never incremented and {@code 0} is returned immediately). This means that matches
     * may overlap.</p>
     * <p>A {@code null} CharSequence will return {@code -1}.</p>
     *
     * <pre>
     ...
     *
     * @return the n-th index of the search CharSequence, {@code -1} ({@code INDEX_NOT_FOUND}) if no match or {@code
     *         null} string input
     * @since 2.1
     ...
     *         the CharSequence to find, may be null
     * @param ordinal
     *         the n-th {@code searchStr} to find, overlapping matches are allowed.
     * @param lastIndex
     ...
     * A negative index is treated as zero. An index greater than the string length is treated as the string length. The
     * start index is always the smaller of the two indices.</p>
     *
     * <pre>
     ...
     * string. An empty ("") remove string will return the source string.</p>
     *
     * <pre>
     * StringUtils.remove(null, *)        = null
     * StringUtils.remove("", *)          = ""
     ...
     *
     * <p>A {@code null} string input returns {@code null}.
     * An empty ("") string input returns an empty string. A null or empty set of search characters returns the input
     * string.</p>
     *
     * <p>The length of the search characters should normally equal the length
     * of the replace characters. If the search characters is longer, then the extra search characters are deleted. If
     * the search characters is shorter, then the extra replace characters are ignored.</p>
     *
     * <pre>
     * StringUtils.replaceChars(null, *, *)           = null
     * StringUtils.replaceChars("", *, *)             = ""
     ...
     * <p>Splits a String by Character type as returned by
     * {@code java.lang.Character.getType(char)}. Groups of contiguous characters of the same type are returned as
     * complete tokens, with the following exception: if {@code camelCase} is {@code true}, the character of type {@code
     * Character.UPPERCASE_LETTER}, if any, immediately preceding a token of type {@code Character.LOWERCASE_LETTER}
     * will belong to the following token rather than to the preceding, if any, {@code Character.UPPERCASE_LETTER}
     * token.
     *
     * @param str
     *         the String to split, may be {@code null}
     ...
     * <p>Splits a String by Character type as returned by
     * {@code java.lang.Character.getType(char)}. Groups of contiguous characters of the same type are returned as
     * complete tokens, with the following exception: the character of type {@code Character.UPPERCASE_LETTER}, if any,
     * immediately preceding a token of type {@code Character.LOWERCASE_LETTER} will belong to the following token
     * rather than to the preceding, if any, {@code Character.UPPERCASE_LETTER} token.
     * <pre>
     ...
     * A {@code null} array will return {@code null}. An empty array will return itself. A {@code null} array entry will
     * be ignored.</p>
     *
     * <pre>
     ...
     * <p>A new array is returned each time, except for length zero.
     * A {@code null} array will return {@code null}. An empty array will return itself. A {@code null} array entry will
     * be ignored. A {@code null} stripChars will strip whitespace as defined by {@link
     ...
     * position and ends before the {@code end} position. All position counting is zero-based -- i.e., to start at the
     * beginning of the string use {@code start = 0}. Negative start and end positions can be used to specify offsets
     * relative to the end of the String.</p>
     *
     ...
     *
     * <p>A {@code null} string input will return {@code null}.
     * An empty ("") string input will return the empty string. An empty or {@code null} separator will return the empty
     * string if the input string is not {@code null}.</p>
     *
     * <p>If nothing is found, the empty string is returned.</p>
     *
     * <pre>
     ...
     *
     * <p>A {@code null} string input will return {@code null}.
     * An empty ("") string input will return the empty string. An empty or {@code null} separator will return the input
     * string.</p>
     *
     * <p>If nothing is found, the string input is returned.</p>
     *
     ...
     * surrogate not preceded by a high surrogate) will be returned as-is.</p>
     *
     * <pre>
     ...
     * Trim removes start and end characters &lt;= 32. To strip whitespace use {@link #strip(String)}.</p>
     *
    ...
    /**
     * <p>Removes control characters (char &lt;= 32) from both
     * ends of this String returning an empty String ("") if the String is empty ("") after the trim or if it is {@code
     * null}.
     *
     * <p>The String is trimmed using {@link String#trim()}.
     * Trim removes start and end characters &lt;= 32. To strip whitespace use {@link #stripToEmpty(String)}.</p>
     *
     * <pre>
    ...
    /**
     * <p>Removes control characters (char &lt;= 32) from both
     * ends of this String returning {@code null} if the String is empty ("") after the trim or if it is {@code null}.
     *
     * <p>The String is trimmed using {@link String#trim()}.
     * Trim removes start and end characters &lt;= 32. To strip whitespace use {@link #stripToNull(String)}.</p>
     *
     * <pre>
     ...
     * standard programming. Instead, the class should be used as {@code StringUtils.trim(" foo ");}.</p>
     *
